                ...
                <section className="relative w-full bg-zinc-900 overflow-hidden min-h-[650px] flex flex-col">
                    ...
                    <div className="relative overflow-hidden text-left z-10 grow flex flex-col justify-center max-w-[1400px]  px-10 sm:px-14 lg:px-44 py-20">
                        <div className="w-full text-left">
                            ...
                            <h1 className="text-5xl sm:text-6xl lg:text-6xl font-black text-white leading-tight mb-6 tracking-tight drop-shadow-lg">
                                ...
                                <span className="text-transparent bg-clip-text bg-linear-to-r from-red-600 to-orange-400">Limitless Opportunity</span>
                            </h1>
                            ...
                            <div className="flex flex-wrap gap-5">
                                <button className="h-14 px-8 rounded-full bg-red-600 text-white font-bold hover:bg-red-700 transition-all shadow-lg shadow-red-600/30 flex items-center gap-3 group">
                                    Start Your Journey
                                    <span className="group-hover:translate-x-1 transition-transform">→</span>
                                </button>
                                <button className="h-14 px-8 rounded-full bg-white/5 backdrop-blur-md text-white font-bold hover:bg-white/10 transition-colors border border-white/20 flex items-center gap-3">
                                    Watch Campus Tour
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="relative z-20 w-full bg-linear-to-t from-slate-50 dark:from-zinc-950 to-transparent pt-12 pb-6">
                        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 -mt-20">
                            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl p-2 max-w-5xl mx-auto border border-gray-100 dark:border-gray-800 overflow-x-auto">
                                <div className="flex min-w-max md:w-full space-x-2">
                                    {['Student', 'Teacher', 'Parent', 'Admin'].map((role, idx) => (
                                        <label key={role} className="flex-1 cursor-pointer group relative">
                                            ...
                                            <div className="flex flex-col md:flex-row items-center justify-center px-4 md:px-6 py-4 rounded-xl text-gray-500 hover:bg-gray-50 dark:hover:bg-zinc-800 peer-checked:bg-red-600 peer-checked:text-white transition-all duration-300">
                    ...
                    <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                ...
                                <div key={item.title} className="group relative bg-white dark:bg-zinc-900 rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-red-600/10 transition-all duration-500 overflow-hidden cursor-pointer border border-gray-100 dark:border-gray-800 hover:-translate-y-2">
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                            <div className="lg:w-1/2 order-2 lg:order-1 relative">
                                <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white dark:border-gray-700">
                                    ...
                                    <div className="absolute bottom-6 right-6 bg-white dark:bg-zinc-800 p-4 rounded-xl shadow-lg max-w-[200px] border border-gray-100 dark:border-gray-600">
                                ...
                                <div className="absolute -z-10 -top-10 -left-10 w-40 h-40 bg-red-600/10 rounded-full blur-3xl"></div>
                            </div>
                            <div className="lg:w-1/2 order-1 lg:order-2">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {[
                                        ...
                                        <div key={feature.title} className="flex flex-col p-4 bg-gray-50 dark:bg-zinc-950 rounded-xl border border-gray-100 dark:border-zinc-800 hover:border-red-600/50 transition-colors">
                ...
                <section className="py-24 bg-red-600 text-white text-center">
                    <div className="max-w-[1000px] mx-auto px-4">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <button className="px-10 py-4 bg-white text-red-600 rounded-full font-bold hover:bg-gray-50 transition-all shadow-xl text-lg">
                                Apply for Admission
                            </button>
                            <button className="px-10 py-4 bg-transparent border-2 border-white/40 text-white rounded-full font-bold hover:bg-white/10 hover:border-white transition-all text-lg">
                                Schedule a Demo
                            </button>
                        </div>
                    </div>
